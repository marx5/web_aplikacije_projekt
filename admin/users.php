<?php 
	...
	if (isset($_POST['_action_']) && $_POST['_action_'] == 'add_user') {
		...
		$query  = " VALUES firstname='" . $_POST['firstname'] . "', lastname='" . $_POST['lastname'] . "', email='" . $_POST['email'] . "', username='" . $_POST['username'] . "', country='" . $_POST['country'] . "', archive='" . $_POST['archive'] . "'";
	...
	if (isset($_GET['edit']) && $_GET['edit'] != '') {
		...
		print '
		<h2>Add user</h2>
		<form action="" id="user_form" name="user_form" method="POST" enctype="multipart/form-data">
			...
			<label for="archive">Archive:</label><br />
            <input type="radio" id="archive" name="archive" value="Y"> YES &nbsp;&nbsp;
			<input type="radio" id="archive" name="archive" value="N" checked> NO
		...
		<div id="users">
			...
			<a href="index.php?menu=' . $menu . '&amp;action=' . $action . '&amp;add=true" class="AddLink">Add users</a>
		</div>';
	}
